...
import { annualisedVolatility, maxDrawdown, riskBand, trailingReturn, weeklyReturns } from "@/lib/stats";
import type {
  BuySimulationResult,
  FitClassification,
  Holding,
...
// Pure series statistics live in `stats.ts` (dependency-free); re-exported here
// so existing `@/lib/analytics` imports keep working.
export { weeklyReturns, annualisedVolatility, maxDrawdown, trailingReturn, riskBand };
